        ...
        <article id="div-comment-<?php comment_ID(); ?>" class="comment-body">
            ...
            <header class="comment-author">
                ...
                <div class="author-meta vcard">
                    <?php printf(__('<span class="author-name">%s</span>', 'genesis_pinnacle'), get_comment_author_link()); ?>
                    <br />
                    <time datetime="<?php echo comment_date('c'); ?>">
                        <a href="<?php echo esc_url(get_comment_link($comment->comment_ID)); ?>">
                            <?php printf(__('Commented on %1$s', 'genesis_pinnacle'), get_comment_date(), get_comment_time()); ?>
                        </a>
                    </time>
                    <?php edit_comment_link(__('(Edit)', 'genesis_pinnacle'), '<span class="edit-link">', '</span>'); ?>
                </div>
            </header>
            ...
            <section class="comment-content">
                <?php if ($comment->comment_approved == '0') : ?>
                    <div class="notice">
                        <p class="alert-info"><?php _e('Your comment is awaiting moderation.', 'genesis_pinnacle'); ?></p>
                    </div>
                <?php endif; ?>
